...
} variables[14] =
{
  ...
  {"curl_time_startupload", CURLINFO_STARTUPLOAD_TIME, writeenv_DOUBLE},
  {"curl_time_finishupload", CURLINFO_FINISHUPLOAD_TIME, writeenv_DOUBLE},
  {"curl_time_startdownload", CURLINFO_STARTDOWNLOAD_TIME, writeenv_DOUBLE},
  {"curl_time_finishdownload", CURLINFO_FINISHDOWNLOAD_TIME, writeenv_DOUBLE},
